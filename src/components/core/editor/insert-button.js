...
const REVERSED_BTN_FONT_SIZE = Object.fromEntries(
  Object.entries(BTN_FONT_SIZE).map(([key, value]) => [value, key])
);
const REVERSED_BTN_BORDER_RADIUS = Object.fromEntries(
  Object.entries(BTN_BORDER_RADIUS).map(([key, value]) => [value, key])
);
...
export const InsertButtonTool = (props) => {
  ...
  InsertButtonTool.open = (editProps) => {
    if (!open) {
      ...
      const backgroundColor =
        window.getComputedStyle(editProps).backgroundColor; // Get background color
      ...
      setOpenNewTab(
        onClickHandler.toString().includes("_blank") ? true : false
      );
  ...
  const handleSubmit = async (event) => {
    ...
    const style = `
        ...
        `;
    const click = openInNewTab
      ? `window.open(
            '${externalLinkUrl}','_blank')`
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        const elements = document
          .querySelector(".k-editor-content")
  ...
  return (
    <React.Fragment>
      <Modal
        show={open}
        onHide={handleModal}
        className="button-modal new-modal embed-link-modal"
      >
                ...
                <div className="insert-button-template-selection">
                      ...
                      <div className="left-top-section-color-picker-container">
                        <div>
                          ...
                          <ColorPicker
                            ...
                            onChange={(e) => {
                              setPreviewBtnTextColor(e.value);
                              setButtonTextPickerOpen(false);
                            }}
                            open={isButtonTextPickerOpen}
                            onActiveColorClick={() => {
                              setButtonTextPickerOpen(true);
                            }}
                            disabled={isLoading}
                          />
                        </div>
                        <div>
                          ...
                          <ColorPicker
                            ...
                            onChange={(e) => {
                              setPreviewButtonColor(e.value);
                              setButtonPickerOpen(!isButtonPickerOpen);
                            }}
                            open={isButtonPickerOpen}
                            onActiveColorClick={() => {
                              setButtonPickerOpen(true);
                            }}
                            disabled={isLoading}
                          />
                        </div>
                  ...
                  <div className="external-link-box">
                    <>
                      ...
                      <Form.Group>
                        <label
                          htmlFor="isOpenNewTab"
                          className="insert-button-checkbox"
                        >
                          <input
                            id="isOpenNewTab"
                            name="isOpenNewTab"
      ...
      >
        <span>
          <img
            ...
            src={require("../../../images/button-icon.png")}
            alt="Button"
          />
        </span>
      </Button>
